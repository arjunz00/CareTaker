...
import { LogOut, Bell, Shield, Heart } from 'lucide-react';
    ...
    <header className="bg-slate-900 border-b border-slate-800 py-3.5 px-6 flex justify-between items-center shadow-md select-none shrink-0 z-30">
      <div className="flex items-center gap-3">
        <button 
          ...
          className="text-slate-400 hover:text-white p-1 rounded hover:bg-slate-800 transition md:block hidden animate-fadeIn"
        ...
        <div>
          <h2 className="text-sm font-black text-white uppercase tracking-wider flex items-center gap-2">
            ...
            AegisNet Family Guardian Console
          </h2>
          <p className="text-[10px] text-slate-500 font-medium">Family Safety & Emergency Triage</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          {isOnline ? 'Active Sensor Sync' : 'Sensor Sync Offline'}
        </span>
        ...
        <div className="flex items-center gap-3 border-l border-slate-800 pl-4">
          <div className="text-right">
            <span className="font-bold text-xs text-white block leading-tight">{guardianName}</span>
            <span className="text-[9px] text-slate-500 font-mono block mt-0.5">{guardianEmail}</span>
          </div>
          <button 
