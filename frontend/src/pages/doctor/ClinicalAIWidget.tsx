    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center select-none border-b border-slate-850 pb-4">
        <div>
          <h1 className="text-xl font-black text-white uppercase flex items-center gap-2">
            ...
            Clinical AI RAG Assistant
          </h1>
          <p className="text-xs text-slate-500 mt-0.5 font-sans">Query clinical summaries, explain risk score spikes, and review baseline profiles via Voice & RAG.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-xs">
        ...
        <div className="lg:col-span-8">
          <HealthAssistant
            role="doctor"
            title="AegisNet Clinical Decision RAG Assistant"
          />
        </div>

        {/* Sidebar disclaimer (4 cols) */}
        <div className="lg:col-span-4 space-y-6 select-none">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl space-y-3.5 text-xs text-slate-400 leading-relaxed font-sans">
            ...
            <p>
              This chatbot is a clinical decision-support tool powered by Role-Specific RAG. It parses longitudinal wearable data ranges, inactivity histories, and risk deviations.
            </p>
            <p>
              It <strong>does not</strong> independently prescribe drugs, schedule clinical consultations, or override physician decisions.
            </p>
          </div>
        </div>
